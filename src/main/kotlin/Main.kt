...
fun main() {
    ...
    val album1 = Album("53:55",
        mutableListOf(Song(SongGenre.POP,Artist("Egor","EGOR NATS"),"Словонепробиваемая"),
            Song(SongGenre.POP,Artist("Egor","EGOR NATS"),"Ты всегда одна"),
            Song(SongGenre.BLUES,Artist("Egor","EGOR NATS"),"Уходи")))
    val album2 = Album("Депрессии не сущетсвует",
        mutableListOf(Song(SongGenre.RAP,Artist("Fedor","STED.D"),"Записки на теле"),
